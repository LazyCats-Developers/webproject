...
function EditPost({
    ...
    const onSubmit = e => {
        ...
        const fetchData = async () => {
            setLoading(true)
            try {
                const res = await axios.put(`${import.meta.env.VITE_REACT_APP_API_URL}/api/blog/edit`,
                    formData,
                    config)
                if (res.status === 200) {
                    await get_blog(slug)
    ...
    const onSubmitDraft = e => {
        ...
        const fetchData = async () => {
            setLoading(true)
            try {
                const res = await axios.put(`${import.meta.env.VITE_REACT_APP_API_URL}/api/blog/draft`,
                    formData,
                    config)
                if (res.status === 200) {
                    await get_blog(slug)
    ...
    const onSubmitPublish = e => {
        ...
        const fetchData = async () => {
            setLoading(true)
            try {
                const res = await axios.put(`${import.meta.env.VITE_REACT_APP_API_URL}/api/blog/publish`,
                    formData,
                    config)
                if (res.status === 200) {
                    await get_blog(slug)
    ...
    const onSubmitDelete = e => {
        ...
        const fetchData = async () => {
            setLoading(true)
            try {
                const res = await axios.delete(`${import.meta.env.VITE_REACT_APP_API_URL}/api/blog/delete/${slug}`,
                    formData,
                    config)
                if (res.status === 200) {
                    navigate(-1)
                                ...
                                <div className="border-b border-gray-200 bg-white px-4 py-5 sm:px-6">
                                    <div className="-ml-4 -mt-4 flex flex-wrap items-center justify-between sm:flex-nowrap">
                                        ...
                                        <div className="ml-4 mt-4 flex-shrink-0">
                                            ...
                                            <a
                                                type="button"
                                                href={`${import.meta.env.VITE_REACT_APP_URL}/blog/${post.slug}`}
                                                target="_blank"
